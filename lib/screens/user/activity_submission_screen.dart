...
class _ActivitySubmissionScreenState extends State<ActivitySubmissionScreen> with WidgetsBindingObserver {
  ...
  Future<void> _pickStravaActivity() async {
    final selected = await showStravaActivityPicker(context: context, accentColor: primaryPurple);
